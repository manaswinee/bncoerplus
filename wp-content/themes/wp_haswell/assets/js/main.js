...
jQuery(document).ready(function($) {
	...
	//CF7 Customize
	jQuery(".wpcf7-form textarea.input__field").unwrap();
	jQuery(".wpcf7-form input.input__field").unwrap();
	...
	*/
	...
	$(window).load(function() {
		...
		//Replace product image mobile
		if($('body').hasClass('single-product')){
			var wooimgurl = $('.woocommerce-main-image').find('img').attr('src');
			$('.woocommerce-main-image').find('img').attr('src',wooimgurl.replace('.jpg','_full.jpg'));
			$('.woocommerce-main-image').find('img').attr('srcset','');
			$('.woocommerce-main-image').find('img').attr('sizes','');
			console.log();
		}
		...
		//Custom Select
		$('.cwr_form select').customSelect({customClass:'cwr_selectbox'});
    ...
    $('#quote-carousel').bind('slid.bs.carousel', function (e) {
    	//console.log($('.carousel-indicators li.active').prev());
    	$('.carousel-indicators li').removeClass('preactive');
    	$('.carousel-indicators li').removeClass('postactive');
    	if($('.carousel-indicators li.active').prev().length)
    		$('.carousel-indicators li.active').prev().addClass('preactive');
    	else
    		$('.carousel-indicators li').last().addClass('preactive');
    	if($('.carousel-indicators li.active').next().length)
    		$('.carousel-indicators li.active').next().addClass('postactive');
    	else
    		$('.carousel-indicators li').first().addClass('postactive');
	}); 
