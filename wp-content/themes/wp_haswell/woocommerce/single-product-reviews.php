				...
				<?php
					...
					$comment_form = array(
						...
						'fields'               => array(
							'author' => '<div class="col-md-4 mb-30">' .
							            '<input id="author" class="comment-form-author form-control" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" aria-required="true" placeholder="'.__( 'NAME', 'woocommerce' ).'"/></div>',
						...
						'label_submit'  => __( 'SEND MESSAGE', 'woocommerce' ),
						'logged_in_as'  => '',
						'comment_field' => ''
					);
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<div class="col-md-4 mb-30"><select name="rating" id="cms-rating">
							<option value="">' . __( 'SELECT A RATING', 'woocommerce' ) . '</option>
					...
					$comment_form['comment_field'] .= '<div class="col-md-12 mb-40"><textarea id="comment" class="comment-form-comment form-control" name="comment" placeholder="'.__('COMMENT', 'woocommerce').'" maxlength="5000" aria-required="true"></textarea></div>';
