...
<div class="table-responsive col-md-12">
	...
	<div class="row cms-coupon-wrap">
			...
			<?php if ( WC()->cart->coupons_enabled() ) { ?>
				<div class="coupon row">
					...
					<div class="col-sm-6 mb-30">
						<input type="submit" class="cms-button medium gray-light w-100-767" name="apply_coupon" value="<?php _e( 'APPLY CODE', 'woocommerce' ); ?>" />	
					</div>
		...
		<div class="col-sm-4 text-right text-center-767 mb-30">
			<input type="submit" class="cms-button medium gray-light w-100-767" name="update_cart" value="<?php _e( 'UPDATE CART', 'woocommerce' ); ?>" />
