...
<header id="masthead" class="site-header">
    <div id="cshero-header" class="cshero-main-header 
        ...
        <div class="container-m-30">
            <div class="row">
                <div id="cshero-header-logo" class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <?php
                        $logo_url = $logo_fixed = '';
                    ...
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <img class="logo-follow-option" alt="" src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/uploads/2019/08/bnc_oer_logo_white.png" <?php echo (isset($haswell_meta->_cms_page_logo_custom_height) && $haswell_meta->_cms_page_logo_custom_height) ? 'style="height: '. $haswell_meta->_cms_page_logo_custom_height.'"' : '' ?>>
                        <img class="logo-fixed hidden" alt="" src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/uploads/2019/08/bnc_oer_logo.png" <?php echo (isset($haswell_meta->_cms_page_logo_custom_height) && $haswell_meta->_cms_page_logo_custom_height) ? 'style="height: '. $haswell_meta->_cms_page_logo_custom_height.'"' : '' ?>>
                    </a>
                    <?php }else { ?>
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                        <img class="logo-follow-option" alt="" src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/uploads/2019/08/bnc_oer_logo.png" <?php echo (isset($haswell_meta->_cms_page_logo_custom_height) && $haswell_meta->_cms_page_logo_custom_height) ? 'style="height: '. $haswell_meta->_cms_page_logo_custom_height.'"' : '' ?>>
                        <img class="logo-fixed hidden" alt="" src="<?php echo esc_url( home_url( '/' ) ); ?>/wp-content/uploads/2019/08/bnc_oer_logo.png" <?php echo (isset($haswell_meta->_cms_page_logo_custom_height) && $haswell_meta->_cms_page_logo_custom_height) ? 'style="height: '. $haswell_meta->_cms_page_logo_custom_height.'"' : '' ?>>
                    </a>
                    <?php } ?>
                </div>
                ...
                <div id="cshero-header-navigation" class="col-xs-12 col-sm-8 col-md-8 col-lg-8 has-search-cart cwr-topRightNav">
