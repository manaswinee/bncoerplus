...
add_action('vc_before_init', 'haswell_animate_lib');

function haswell_set_param_forvc() {
	vc_add_param('cms_contact_info', array(
        'type' => 'dropdown',
...
add_action('vc_after_init', 'haswell_set_param_forvc');
